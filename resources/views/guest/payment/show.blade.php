...
<body>
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light p-0">
            <a class="navbar-brand ml-1 " href="#"> MUAHECoffee </a>
        ...
        <div class="col-6 text-center ml-5">
            @if ($errors->any())
                ...
                @endif
            <div class="broder border mt-5 ">
            <h4 class="text-center font-italic p-3 mt-2">Thông tin đặt hàng</h4>
                <form class="p-3" action="{{ route('guest.payment.store')}}" method="post">
                @csrf 
                    ...
                    <div class="form-group row">
                        <label for="phonenumber" class="col-sm-4 col-form-label">Điện thoại:</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" name="phonenumber" id="phonenumber" required autofocus>
                        </div>
                    </div>
                    <div class="form-group row mt-5 mb-5">
                      ...
                      <div class="col-6">
                      <button type="submit" name="btn-buy" class="btn btn-outline-dark float-right"><i class="fas fa-check"></i> ĐẶT HÀNG</button>
                      </div>
                    </div>
                </form>
            </div>
        </div>
            <div class="col-5 text-center mr-5">
            <div class="row">
          ...
          <div class="row ">
          <div class="col-6 ">
            <a class="btn btn-outline-dark " href="{{ route('guest.cart.show') }}">TRỞ VỀ</a>
          </div>
          <div class="col-6">
            <div class="row">TỔNG CỘNG</div>
            <br>
            <div class="row">
              <h5>Tổng tiền: </h5> 
              <div class="float-right"><h5> {{ $item->subtotal }}</h5></div>
            </div>
            <br>
          </div>
          </div>
        ...
        <!-- <div class="row col-6 mt-5 ">
          <div class="col-6">
            <a class="btn btn-outline-dark ml-5" href="{{ route('guest.cart.show') }}">TRỞ VỀ</a>
          </div>
          <div class="col-6">
            <div class="row">TỔNG CỘNG</div>
            <br>
            <div class="row">
              <h5>Tổng tiền: </h5> 
              <div class=" col-6 float-right"><h5> {{ Cart::subtotal() }}</h5></div>
            </div>
            <br>
          </div>
        </div> -->
